      ...
      {jwtToken !== undefined ? (
        productList.length > 0 ? (
          ...
          <div className="my-2 px-10 md:px-0 min-h-lvh bg-white rounded-xs flex flex-col items-center justify-center">
            <img className="w-[50%] md:w-[40%] lg:w-[30%]" src={EmptyCart} alt="empty cart" />
            <h1 className="text-xl md:text-2xl font-semibold my-2">Your cart is empty!</h1>
            <p className="text-center">Add some products to your cart to view them here.</p>
          </div>
        )
      ) : (
